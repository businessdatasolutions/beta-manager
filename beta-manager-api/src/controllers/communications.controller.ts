...
function transformCommunication(comm: BaserowCommunication) {
  return {
    ...
    channel: comm.channel?.value as CommunicationChannel,
    direction: comm.direction?.value as CommunicationDirection,
    subject: comm.subject,
    content: comm.content,
    template_name: comm.template_name,
    status: comm.status?.value as CommunicationStatus | undefined,
